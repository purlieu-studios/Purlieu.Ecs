...
public class MONITORING_HealthCheckTests
{
    ...
    public void World_AutomaticallyRecordsEntityOperations()
    {
        ...
        _world.AddComponent(entity1, new Purlieu.Logic.Components.Position(1, 2, 3));
        _world.AddComponent(entity1, new Purlieu.Logic.Components.Velocity(4, 5, 6));
        _world.AddComponent(entity2, new Purlieu.Logic.Components.Position(7, 8, 9));
    ...
    public void World_RecordsArchetypeTransitions()
    {
        ...
        _world.AddComponent(entity, new Purlieu.Logic.Components.Position(1, 2, 3)); // Empty -> Position
        _world.AddComponent(entity, new Purlieu.Logic.Components.Velocity(4, 5, 6)); // Position -> Position+Velocity
